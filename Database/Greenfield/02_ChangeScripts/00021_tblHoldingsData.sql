...
CREATE TABLE [dbo].[tblHoldingsData](
	...
	[ISSUER_ID] [int] NULL,
	[ASEC_SEC_SHORT_NAME] [varchar](255) NULL,
	...
	[PORTFOLIO_DIRTY_VALUE_PC] [real] NULL,
	[PORTFOLIO_WEIGHT] [real] NULL,
	[BENCHMARK_WEIGHT] [real] NULL,
	[ASH_EMM_MODEL_WEIGHT] [real] NULL,
	[MARKET_CAP_IN_USD] [real] NULL,
 ...
 CONSTRAINT [PK_tblHoldingsData] PRIMARY KEY CLUSTERED 
(
	[ID] ASC
