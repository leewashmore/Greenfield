...
declare @RequiredDBVersion as nvarchar(100) = '00231'
declare @CurrentScriptVersion as nvarchar(100) = '00232'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:206 Trailing P/Revenue
--
--			Current Market Cap* / Sum of previous 4 quarters RTLR**
--
-- Author:	Anupriya
-- Date:	July 18, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_206', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_206;
GO

CREATE procedure [dbo].[AIMS_Calc_206](
