...
declare @RequiredDBVersion as nvarchar(100) = '00180'
declare @CurrentScriptVersion as nvarchar(100) = '00181'
...
GO
            IF OBJECT_ID ( 'AIMS_Calc_150', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_150;
GO
------------------------------------------------------------------------
...
-- Date:	July 12, 2012
------------------------------------------------------------------------
create procedure AIMS_Calc_150(
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  150 as DATA_ID										-- 
		,  a.AMOUNT / b.AMOUNT as AMOUNT						-- ANTL /LDBT
...
-- exec AIMS_Calc_150 187318
-- select * from PERIOD_FINANCIALS where DATA_ID = 150
