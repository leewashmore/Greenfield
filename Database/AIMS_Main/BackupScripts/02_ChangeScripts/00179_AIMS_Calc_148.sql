...
declare @RequiredDBVersion as nvarchar(100) = '00178'
declare @CurrentScriptVersion as nvarchar(100) = '00179'
...
GO
            IF OBJECT_ID ( 'AIMS_Calc_148', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_148;
GO
------------------------------------------------------------------------
...
-- Date:	July 12, 2012
------------------------------------------------------------------------
create procedure AIMS_Calc_148(
