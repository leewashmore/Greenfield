...
declare @RequiredDBVersion as nvarchar(100) = '00277'
declare @CurrentScriptVersion as nvarchar(100) = '00278'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:256 Trailing Total Debt  
--
--			:   Previous Annual STLD*
--
-- Author:	Anupriya
-- Date:	July 27, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_256', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_256;
GO

CREATE procedure [dbo].[AIMS_Calc_256](
