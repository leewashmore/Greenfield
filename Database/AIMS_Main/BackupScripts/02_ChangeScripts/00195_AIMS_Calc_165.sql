...
declare @RequiredDBVersion as nvarchar(100) = '00194'
declare @CurrentScriptVersion as nvarchar(100) = '00195'
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
	  ...
	  into #B
	  from #B104 a
	   left join #B154 b on b.DATA_SOURCE = a.DATA_SOURCE and b.PERIOD_YEAR = a.PERIOD_YEAR 
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT /b.AMOUNT as AMOUNT						-- 185/(104 - [154 x (1-155) x (1-232)])   
