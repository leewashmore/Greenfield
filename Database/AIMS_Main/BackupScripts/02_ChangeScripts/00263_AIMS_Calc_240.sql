...
declare @RequiredDBVersion as nvarchar(100) = '00262'
declare @CurrentScriptVersion as nvarchar(100) = '00263'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:240 Net Income Growth, 2 Year (Annualized) 
--
--			(((177 for Period * 177 for Period -1)^1/2)-1)*100
--
-- Author:	Shivani
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_240', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_240;
GO

CREATE procedure [dbo].[AIMS_Calc_240](
