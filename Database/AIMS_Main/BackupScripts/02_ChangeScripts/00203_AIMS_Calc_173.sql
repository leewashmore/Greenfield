...
declare @RequiredDBVersion as nvarchar(100) = '00202'
declare @CurrentScriptVersion as nvarchar(100) = '00203'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:173 Loan Growth (YOY) 
--
--			(ANTL for Year/ ANTL for Prior Year)-1
--
-- Author:	Shivani
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_173', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_173;
GO

CREATE procedure [dbo].[AIMS_Calc_173](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  (a.AMOUNT /b.AMOUNT)-1 as AMOUNT						-- (ANTL for Year/ ANTL for Prior Year)-1
