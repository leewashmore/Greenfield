...
declare @RequiredDBVersion as nvarchar(100) = '00224'
declare @CurrentScriptVersion as nvarchar(100) = '00225'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:199 Forward Free Cash Flow Yield
--
--			:   Sum of next 4 quarters Free Cash Flow (157)**/Current Market Cap*
--
-- Author:	Shivani 
-- Date:	July 18, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_199', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_199;
GO

CREATE procedure [dbo].[AIMS_Calc_199](
