...
declare @RequiredDBVersion as nvarchar(100) = '00266'
declare @CurrentScriptVersion as nvarchar(100) = '00267'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:244  Forward Net Income Growth, 3 Year (Annualized)
--
--(((Sum of NINC for QP1/ Sum of NINC QP0 x Sum of NINC QP2/ Sum of NINC QP1 x Sum of NINC QP3/ Sum of NINC QP2)^1/3)-1)*100
--
-- Author:	Prerna
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_244', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_244;
GO

CREATE procedure [dbo].[AIMS_Calc_244](
