...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PERIOD_FINANCIALS_ISSUER_MAIN]') AND type in (N'U'))
DROP TABLE [dbo].[PERIOD_FINANCIALS_ISSUER_MAIN]
GO
...
CREATE TABLE [dbo].[PERIOD_FINANCIALS_ISSUER_MAIN](
