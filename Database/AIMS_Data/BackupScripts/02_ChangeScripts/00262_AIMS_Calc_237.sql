...
declare @RequiredDBVersion as nvarchar(100) = '00261'
declare @CurrentScriptVersion as nvarchar(100) = '00262'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:237 Forward EV/Revenue 
--
--			Current Enterprise Value* / Sum of next 4 quarters RTLR (11)**
--
-- Author:	Anupriya
-- Date:	July 20, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_237', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_237;
GO

CREATE procedure [dbo].[AIMS_Calc_237](
