...
declare @RequiredDBVersion as nvarchar(100) = '00302'
declare @CurrentScriptVersion as nvarchar(100) = '00303'
...
-- Date:	Sept 6, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'CCE_Calc_170', 'P' ) IS NOT NULL 
DROP PROCEDURE CCE_Calc_170;
GO

CREATE procedure [dbo].[CCE_Calc_170](
...
-- exec CCE_Calc_170 '847547'
-- select * from CURRENT_CONSENSUS_ESTIMATES where ESTIMATE_ID = 170
