...
declare @RequiredDBVersion as nvarchar(100) = '00239'
declare @CurrentScriptVersion as nvarchar(100) = '00240'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:214 Trailing Revenue Growth

-- (Sum of previous 4 quarters NINC*/ Sum of 4 quarters NINC prior to previous 4**) -1
--
-- Author:	Aniket
-- Date:	July 20, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_214', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_214;
GO

CREATE procedure [dbo].[AIMS_Calc_214](
