...
declare @RequiredDBVersion as nvarchar(100) = '00179'
declare @CurrentScriptVersion as nvarchar(100) = '00180'
...
GO
            IF OBJECT_ID ( 'AIMS_Calc_149', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_149;
GO
------------------------------------------------------------------------
...
-- Date:	July 12, 2012
------------------------------------------------------------------------
create procedure AIMS_Calc_149(
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  149 as DATA_ID										-- 
		,  a.AMOUNT / b.AMOUNT as AMOUNT						-- Net Debt/Equity
...
-- exec AIMS_Calc_149 223340	--847078
-- select * from PERIOD_FINANCIALS where DATA_ID = 149
