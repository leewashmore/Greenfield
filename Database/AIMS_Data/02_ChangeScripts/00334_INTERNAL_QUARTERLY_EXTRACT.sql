...
declare @RequiredDBVersion as nvarchar(100) = '00333'
declare @CurrentScriptVersion as nvarchar(100) = '00334'
...
--MODIFIED 2/1/13 (JM) to remove "actual" internal as a source as these "actuals" are not truly actual quarter numbers
