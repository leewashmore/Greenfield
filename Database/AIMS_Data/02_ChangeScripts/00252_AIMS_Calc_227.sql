...
declare @RequiredDBVersion as nvarchar(100) = '00251'
declare @CurrentScriptVersion as nvarchar(100) = '00252'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:227 Net Working Capital
--
--			ATCA - LTCL
--
-- Author:	Prerna
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_227', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_227;
GO

CREATE procedure [dbo].[AIMS_Calc_227](
