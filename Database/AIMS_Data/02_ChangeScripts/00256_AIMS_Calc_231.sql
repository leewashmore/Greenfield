...
declare @RequiredDBVersion as nvarchar(100) = '00255'
declare @CurrentScriptVersion as nvarchar(100) = '00256'
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  ((a.amount/((b.amount + c.amount)/2)) * (1 + ((-1*d.amount)/a.amount)))as AMOUNT						-- (NINC/ (QTLE + QTLE for Prior Period)/2) x (1 + (FCDP/NINC))
