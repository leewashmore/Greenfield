...
declare @RequiredDBVersion as nvarchar(100) = '00171'
declare @CurrentScriptVersion as nvarchar(100) = '00172'
...
GO
            IF OBJECT_ID ( 'AIMS_Calc_141', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_141;
GO
------------------------------------------------------------------------
...
-- Date:	July 2, 2012
------------------------------------------------------------------------
create procedure AIMS_Calc_141(
...
-- exec AIMS_Calc_141 223340	--847078
-- select * from PERIOD_FINANCIALS where DATA_ID = 141
