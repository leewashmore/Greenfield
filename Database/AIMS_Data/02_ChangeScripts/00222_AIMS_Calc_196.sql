...
declare @RequiredDBVersion as nvarchar(100) = '00221'
declare @CurrentScriptVersion as nvarchar(100) = '00222'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:196 Non-Interest Income, Bank Growth (YOY)
--
--			(SNII for Year/ SNII for Prior Year)-1
--
-- Author:	Prerna
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_196', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_196;
GO

CREATE procedure [dbo].[AIMS_Calc_196](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  (a.AMOUNT /b.AMOUNT)-1 as AMOUNT						--  (SNII for Year/ SNII for Prior Year)-1
