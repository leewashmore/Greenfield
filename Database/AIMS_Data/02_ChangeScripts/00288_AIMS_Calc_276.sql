...
declare @RequiredDBVersion as nvarchar(100) = '00287'
declare @CurrentScriptVersion as nvarchar(100) = '00288'
...
------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:276 Customer Deposits/Liabilities  
--
--			(LDBT/LTLL)
--
-- Author:	Prerna
-- Date:	July 16, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_276', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_276;
GO

create procedure [dbo].[AIMS_Calc_276](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT /b.AMOUNT as AMOUNT						-- (LDBT/LTLL)
