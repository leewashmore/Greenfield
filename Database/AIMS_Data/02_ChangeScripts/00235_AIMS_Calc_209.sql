...
declare @RequiredDBVersion as nvarchar(100) = '00234'
declare @CurrentScriptVersion as nvarchar(100) = '00235'
...
--
--			Current Market Cap* / Sum of previous 4 quarters QTLE**
--
-- Author:	Anupriya
-- Date:	July 18, 2012
------------------------------------------------------------------------
...
as
 ...
 ---- Total amount for all the fiscal quarters within an year --- 
	...
	select distinct a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT /b.AMOUNT as AMOUNT						-- Current Market Cap* / Sum of previous 4 quarters QTLE**
