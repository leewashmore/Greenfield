...
declare @RequiredDBVersion as nvarchar(100) = '00248'
declare @CurrentScriptVersion as nvarchar(100) = '00249'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:224 Equity/Total Assets
--
--			QTLE/ ATOT
--
-- Author:	 Prerna
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_224', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_224;
GO

CREATE procedure [dbo].[AIMS_Calc_224](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT /  b.AMOUNT as AMOUNT			            -- QTLE/ ATOT
