...
declare @RequiredDBVersion as nvarchar(100) = '00216'
declare @CurrentScriptVersion as nvarchar(100) = '00217'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:190 Net Debt
--
--			STLD - SCSI
--
-- Author:	Prerna
-- Date:	July 17, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_190', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_190;
GO

CREATE procedure [dbo].[AIMS_Calc_190](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  ( a.AMOUNT - b.AMOUNT) as AMOUNT			-- STLD - SCSI
