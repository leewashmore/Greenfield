...
declare @RequiredDBVersion as nvarchar(100) = '00181'
declare @CurrentScriptVersion as nvarchar(100) = '00182'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:151 Loans/Assets
--
--			ANTL / ATOT
--
-- Author:	Shivani
-- Date:	July 13, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_151', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_151;
GO

CREATE procedure [dbo].[AIMS_Calc_151](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT / b.AMOUNT as AMOUNT						-- ANTL / ATOT
