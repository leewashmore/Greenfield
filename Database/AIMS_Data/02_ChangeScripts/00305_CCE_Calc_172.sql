...
declare @RequiredDBVersion as nvarchar(100) = '00304'
declare @CurrentScriptVersion as nvarchar(100) = '00305'
...
-- Date:	Sept 6, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'CCE_Calc_172', 'P' ) IS NOT NULL 
DROP PROCEDURE CCE_Calc_172;
GO

CREATE procedure [dbo].[CCE_Calc_172](
...
-- exec CCE_Calc_172 '847547'
-- select * from CURRENT_CONSENSUS_ESTIMATES where ESTIMATE_ID = 172
