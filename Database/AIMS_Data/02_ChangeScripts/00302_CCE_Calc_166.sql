...
declare @RequiredDBVersion as nvarchar(100) = '00301'
declare @CurrentScriptVersion as nvarchar(100) = '00302'
...
-- Date:	Sept 6, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'CCE_Calc_166', 'P' ) IS NOT NULL 
DROP PROCEDURE CCE_Calc_166;
GO

CREATE procedure [dbo].[CCE_Calc_166](
...
-- exec CCE_Calc_166 '847547'
-- select * from CURRENT_CONSENSUS_ESTIMATES where ESTIMATE_ID = 166
