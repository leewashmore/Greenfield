...
as
 ...
 -- Add the data to the table
	...
	select a.ISSUER_ID, '', a.COA_TYPE, a.DATA_SOURCE, a.DATA_SOURCE
		...
		,  279 as DATA_ID							-- DATA_ID:279 
		,  (a.AMOUNT) as AMOUNT		-- Sum of next 4 quarters NINC**
	...
	if @CALC_LOG = 'Y'
		BEGIN	
			...
			select GETDATE() as LOG_DATE, 279 as DATA_ID, isnull(@ISSUER_ID, ' ') as ISSUER_ID, ' ' as PERIOD_TYPE
				...
				, 'ERROR calculating 279 Forward Earnings .  DATA_ID:44  No data or missing Next quarters' as TXT
