...
declare @RequiredDBVersion as nvarchar(100) = '00168'
declare @CurrentScriptVersion as nvarchar(100) = '00169'
...
GO
            IF OBJECT_ID ( 'AIMS_Calc_138', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_138;
GO
------------------------------------------------------------------------
...
-- Date:	July 2, 2012
------------------------------------------------------------------------
create procedure AIMS_Calc_138(
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT / b.AMOUNT as AMOUNT						-- SNII/RTLR
