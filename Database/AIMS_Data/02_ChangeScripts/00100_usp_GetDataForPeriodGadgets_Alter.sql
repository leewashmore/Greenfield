...
declare @RequiredDBVersion as nvarchar(100) = '00099'
declare @CurrentScriptVersion as nvarchar(100) = '00100'
...
select gt.GRID_ID as GridId, SHOW_GRID as ShowGrid,SUBSTRING (GRID_DESC,1,CHARINDEX('(',GRID_DESC)-1) as GridDesc,
