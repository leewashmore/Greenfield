...
declare @RequiredDBVersion as nvarchar(100) = '00122'
declare @CurrentScriptVersion as nvarchar(100) = '00123'
...
BEGIN
	...
	Select Distinct(COMMODITY_ID) from COMMODITY_FORECASTS
