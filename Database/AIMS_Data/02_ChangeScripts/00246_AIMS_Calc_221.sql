...
declare @RequiredDBVersion as nvarchar(100) = '00245'
declare @CurrentScriptVersion as nvarchar(100) = '00246'
...
GO
            ------------------------------------------------------------------------
-- Purpose:	This procedure calculates the value for DATA_ID:221 Capex/Depreciation
--
--			SCEX /SDPR
--
-- Author:	Shivani
-- Date:	July 16, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_221', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_221;
GO

CREATE procedure [dbo].[AIMS_Calc_221](
...
--	 order by a.ISSUER_ID, a.COA_TYPE, a.DATA_SOURCE, a.PERIOD_TYPE, a.PERIOD_YEAR,  a.FISCAL_TYPE, a.CURRENCY
	...
	if @CALC_LOG = 'Y'
		BEGIN	
			...
			select GETDATE() as LOG_DATE, 221 as DATA_ID, a.ISSUER_ID, a.PERIOD_TYPE
				,  a.PERIOD_YEAR,  a.PERIOD_END_DATE,  a.FISCAL_TYPE,  a.CURRENCY
				, 'ERROR calculating 221 Capex/Depreciation.  DATA_ID:118 SCEX is missing'
			  from #B a
			...
			select GETDATE() as LOG_DATE, 221 as DATA_ID, isnull(@ISSUER_ID, ' ') as ISSUER_ID, ' ' as PERIOD_TYPE
				,  0 as PERIOD_YEAR,  '1/1/1900' as PERIOD_END_DATE,  ' ' as FISCAL_TYPE,  ' ' as CURRENCY
				, 'ERROR calculating 221 Capex/Depreciation.  DATA_ID:118 SCEX no data' as TXT
