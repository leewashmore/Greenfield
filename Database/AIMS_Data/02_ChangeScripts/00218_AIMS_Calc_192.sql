...
declare @RequiredDBVersion as nvarchar(100) = '00217'
declare @CurrentScriptVersion as nvarchar(100) = '00218'
...
as
	...
	select b.ISSUER_ID, b.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT /b.AMOUNT as AMOUNT						-- 124/185
		,  '124(' + CAST(a.AMOUNT as varchar(32)) + ') / 185(' + CAST(b.AMOUNT as varchar(32)) + ')' as CALCULATION_DIAGRAM
		,  a.SOURCE_CURRENCY
		,  a.AMOUNT_TYPE
	  from #A a
