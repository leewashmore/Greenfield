...
as
	...
	select pf.* 
	 ...
	 where DATA_ID = 92			-- Minority Interest
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  a.AMOUNT as AMOUNT						-- Previous Annual Minority Interest (92)*
		,  'Previous Annual Minority Interest(' + CAST(a.AMOUNT as varchar(32)) + ')' as CALCULATION_DIAGRAM
		,  a.SOURCE_CURRENCY
		,  a.AMOUNT_TYPE
	  from #A a	
	 where 1=1 	  
