...
declare @RequiredDBVersion as nvarchar(100) = '00200'
declare @CurrentScriptVersion as nvarchar(100) = '00201'
...
-- Date:	July 15, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'AIMS_Calc_171', 'P' ) IS NOT NULL 
DROP PROCEDURE AIMS_Calc_171;
GO

CREATE procedure [dbo].[AIMS_Calc_171](
...
as
	...
	select a.ISSUER_ID, a.SECURITY_ID, a.COA_TYPE, a.DATA_SOURCE, a.ROOT_SOURCE
		...
		,  171 as DATA_ID										-- DATA_ID:171 P/CE 
		,  a.AMOUNT /b.AMOUNT as AMOUNT						-- 185/117
		,   '185(' + CAST(a.AMOUNT as varchar(32)) + ') / 117(' + CAST(b.AMOUNT as varchar(32)) + ')' as CALCULATION_DIAGRAM
		,  a.SOURCE_CURRENCY
		,  a.AMOUNT_TYPE
	  from #A a
