...
declare @CurrentScriptVersion as nvarchar(100) = '00030'
...
/****** Object:  StoredProcedure [dbo].[GetFinstatDetail]    Script Date: 08/30/2012 17:09:27 ******/
SET ANSI_NULLS ON
GO
...
SELECT  aa.DATA_SOURCE,
		...
		aa.ROOT_SOURCE_DATE,
		bb.ESTIMATE_ID,
		isnull(aa.PERIOD_YEAR,4000) AS [PERIOD_YEAR],
		aa.DATA_ID,
		aa.AMOUNT,
		bb.MULTIPLIER,
		bb.DECIMALS,
