...
declare @RequiredDBVersion as nvarchar(100) = '00300'
declare @CurrentScriptVersion as nvarchar(100) = '00301'
...
-- Date:	Sept 6, 2012
------------------------------------------------------------------------
IF OBJECT_ID ( 'CCE_Calc_164', 'P' ) IS NOT NULL 
DROP PROCEDURE CCE_Calc_164;
GO

CREATE procedure [dbo].[CCE_Calc_164](
...
-- exec CCE_Calc_164 '847547'
-- select * from CURRENT_CONSENSUS_ESTIMATES where ESTIMATE_ID = 164
