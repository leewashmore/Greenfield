...
namespace GreenField.Common.DragDockPanelControls
{
    ...
    public class DraggablePanel : AnimatedHeaderedContentControl
    {
        ...
        public static readonly DependencyProperty DraggingEnabledProperty =
            DependencyProperty.Register("DraggingEnabled", typeof (bool), typeof (DraggablePanel),
        ...
        public override void OnApplyTemplate()
        {
            ...
            var gripBarElement = GetTemplateChild(ElementGripBarElement) as FrameworkElement;
            if (gripBarElement != null)
            {
                gripBarElement.MouseLeftButtonDown += GripBarElement_MouseLeftButtonDown;
                gripBarElement.MouseMove += GripBarElement_MouseMove;
                gripBarElement.MouseLeftButtonUp += GripBarElement_MouseLeftButtonUp;
            }
        }
        ...
        private void GripBarElement_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            {
                DragFinished(this,
                             new DragEventArgs(position.X - LastDragPosition.X, position.Y - LastDragPosition.Y, e));
            }
        }
