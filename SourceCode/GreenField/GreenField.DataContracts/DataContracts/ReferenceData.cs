...
namespace GreenField.DataContracts
{
    ...
    public class ReferenceData
    {
        ...
        [DataMember]
        public String SEC_SECIK { get; set; }

        [DataMember]
        public String SECFC18_SECFC18IK { get; set; }

        [DataMember]
        public String SECFC19_SECFC19IK { get; set; }

        [DataMember]
        public String SECFC2_SECFC2SHORT { get; set; }

        [DataMember]
        public String SECFC20_SECFC20IK { get; set; }

        [DataMember]
        public String CURR_QT_CUR { get; set; }

        [DataMember]
        public String SEC_QUOCUR_PERFCUR_OVERRIDE { get; set; }

        [DataMember]
        public String SEC_TRS_UNDERLY { get; set; }     
    }
}