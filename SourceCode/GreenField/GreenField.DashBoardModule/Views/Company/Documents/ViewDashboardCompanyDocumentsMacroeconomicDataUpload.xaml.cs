...
{
    /// <summary>
    /// Code behind for ViewDashboardCompanyDocumentsMacroeconomicDataUpload
    /// </summary>
    [Export]
    public partial class ViewDashboardCompanyDocumentsMacroeconomicDataUpload : UserControl, INavigationAware
    {
        #region Fields
        /// <summary>
        ...
        public ViewDashboardCompanyDocumentsMacroeconomicDataUpload(ILoggerFacade logger1, IEventAggregator eventAggregator1,
            IDBInteractivity dbInteractivity)
        {
            ...
            this.tbHeader.Text = "Macroeconomic Data Upload";
        }
        #endregion
