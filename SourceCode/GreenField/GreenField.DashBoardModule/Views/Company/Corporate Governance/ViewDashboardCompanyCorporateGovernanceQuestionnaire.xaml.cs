...
{
    /// <summary>
    /// Code behind for ViewDashboardCompanyCorporateGovernanceQuestionnaire
    /// </summary>
    [Export]
    public partial class ViewDashboardCompanyCorporateGovernanceQuestionnaire : UserControl, INavigationAware
    {
        #region Fields
        /// <summary>
        ...
        public ViewDashboardCompanyCorporateGovernanceQuestionnaire(ILoggerFacade logger1, IEventAggregator eventAggregator1,
            IDBInteractivity dbInteractivity)
        {
            ...
            this.tbHeader.Text = "";//GadgetNames.PORTFOLIO_ENRICHMENT_SCREEN_MOCKUP;
        }
        #endregion
