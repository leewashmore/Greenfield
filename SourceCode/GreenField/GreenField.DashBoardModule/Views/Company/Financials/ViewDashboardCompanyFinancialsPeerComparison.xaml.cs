...
{
    /// <summary>
    /// Code behind for ViewDashboardCompanyFinancialsPeerComparison
    /// </summary>
    [Export]
    public partial class ViewDashboardCompanyFinancialsPeerComparison : UserControl, INavigationAware
    {
        #region Fields
        /// <summary>
        ...
        public ViewDashboardCompanyFinancialsPeerComparison(ILoggerFacade logger1, IEventAggregator eventAggregator1,
            IDBInteractivity dbInteractivity)
        {
            ...
            this.tbHeader.Text = "Change Request Addition";            
        }
        #endregion
