...
namespace GreenField.DashboardModule.Views
{
    ...
    /// </summary>
    [Export]
    public partial class ViewDashboardCompanyInvestmentContext : UserControl, INavigationAware
    {
        #region Fields
        /// <summary>
        ...
        public ViewDashboardCompanyInvestmentContext(ILoggerFacade logger1, IEventAggregator eventAggregator1,
            IDBInteractivity dbInteractivity)
        {
            ...
            this.tbHeader.Text = GadgetNames.INVESTMENT_CONTEXT;
        }
        #endregion
        ...
        public void HandleDashboardGadgetLoad(DashboardGadgetPayload payload)
        {
            ...
            this.cctrDashboardContent.Content = new ViewInvestmentContext(new ViewModelInvestmentContext(param));
        }
        #endregion
