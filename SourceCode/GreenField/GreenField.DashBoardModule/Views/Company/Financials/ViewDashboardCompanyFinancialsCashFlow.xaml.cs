...
{
    /// <summary>
    /// Code behind for ViewDashboardCompanyFinancialsCashFlow
    /// </summary>
    [Export]
    public partial class ViewDashboardCompanyFinancialsCashFlow : UserControl, INavigationAware
    {
        #region Fields
        /// <summary>
        ...
        public ViewDashboardCompanyFinancialsCashFlow(ILoggerFacade logger1, IEventAggregator eventAggregator1,
            IDBInteractivity dbInteractivity)
        {
            ...
            this.tbHeader.Text = GadgetNames.EXTERNAL_RESEARCH_CASH_FLOW;            
        }
        #endregion
