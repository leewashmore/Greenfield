...
{
    /// <summary>
    /// Code behind for ViewDashboardCompanyChartingClosingPrice
    /// </summary>
    [Export, PartCreationPolicy(CreationPolicy.Shared)]
    public partial class ViewDashboardCompanyChartingClosingPrice : UserControl, INavigationAware
    {
        #region Fields      
        /// <summary>
        ...
        public ViewDashboardCompanyChartingClosingPrice(ILoggerFacade logger1, IEventAggregator eventAggregator1, IDBInteractivity dbInteractivity)
        {
            InitializeComponent();
