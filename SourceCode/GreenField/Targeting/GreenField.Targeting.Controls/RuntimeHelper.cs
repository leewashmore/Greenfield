...
namespace GreenField.Targeting.Controls
{
    ...
    {
        public static void TakeCareOfResult<TResult, TValue>(String signature, TResult e, Func<TResult, TValue> getter, Action<TValue> callback, Action<Exception> errorHandler)
            where TResult : AsyncCompletedEventArgs
        {
            try
            {
                TakeCareOfResult<TResult, TValue>(signature, e, getter, callback);
            }
        ...
        private static void TakeCareOfResult<TResult, TValue>(String signature, TResult e, Func<TResult, TValue> getter, Action<TValue> callback)
            where TResult : AsyncCompletedEventArgs
        {
            try
            {
