...
{
    public class SecurityPickerViewModelComposition : NotificationObject
    {
        ...
        [DebuggerStepThrough]
        public SecurityPickerViewModelComposition(ICommunicationState communicationState, ISecurityPickerClientFactory clientFactory)
        {
