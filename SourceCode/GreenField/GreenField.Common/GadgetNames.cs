...
namespace GreenField.Common
{
    public static class GadgetNames
    {
        ...
        public static string EXTERNAL_RESEARCH_CONSENSUS_MEDIAN_ESTIMATES = "Consensus Median Estimates";
        public static string EXTERNAL_RESEARCH_CONSENSUS_VALUATIONS = "Consensus Valuations";
        #endregion

        #region Estimates Details
        public static string EXTERNAL_RESEARCH_CONSENSUS_DETAIL = "Consensus Estimates Detail";
        #endregion
        ...
        public static string HOLDINGS_VALUATION_QUALITY_GROWTH_MEASURES = "Valuation, Quality, & Growth Measures";
        ...
        public static string ICPRESENTATION_CREATE_EDIT = "Investment Committee Presentation Upload/Edit";
        ...
        public static string ICPRESENTATION_PRESENTATIONS = "Investment Committee(IC) Presentation Overview";

        public static string ICPRESENTATION_UPLOAD_EDIT = "Investment Committee Presentation Upload/Edit";

        public static string ICPRESENTATION_PRESENTATIONS_NEW = "Investment Committee Presenation - New";
