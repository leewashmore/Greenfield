...
namespace GreenField.Targeting.Backend.Helpers
{
    ...
    {
        private readonly TopDown.FacingClient.FacadeSettings settings;

        public TargetingServiceHostFactory()
        {
            this.settings = CreateFacadeSettings(ConfigurationSettings.AimsConnectionString, ConfigurationSettings.ShouldDropRepositoriesOnEachReload);
        }
        ...
        protected static TopDown.FacingClient.FacadeSettings CreateFacadeSettings(String connectionString, Boolean shouldDropRepositories)
        {
            try
            {
        ...
        private static TopDown.FacingClient.FacadeSettings CreateFacadeSettingsUnsafe(String connectionString, Boolean shouldDropRepositories)
        {
            ...
            var bgaSerializer = new TopDown.FacingClient.BroadGlobalActive.Serializer(
                new TopDown.FacingClient.Serializer(),
                bptChangeDetector
            );

            var result = new TopDown.FacingClient.FacadeSettings(
                facade,
                bgaSerializer
            );
