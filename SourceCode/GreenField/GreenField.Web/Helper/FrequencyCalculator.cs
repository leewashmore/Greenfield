...
namespace GreenField.Web.Helper
{
    public static class FrequencyCalculator
    {
        public static List<PricingReferenceData> RetrieveDataAccordingToFrequency(List<PricingReferenceData> objPricingData, DateTime startDate, DateTime endDate, string FrequencyInterval)
        {
            ...
            switch (FrequencyInterval)
            {
                ...
                case ("Monthly"):
                    {
                        ...
                        for (int i = 0; i < totalYear; i++)
                        {
                            month = 1;
                            year++;
                            for (int j = 0; j < totalMonths - monthsLeftInCurrentYear; j++)
                            {
                                int numberOfDays = DateTime.DaysInMonth(year, month);
                                DateTime lastDay = new DateTime(year, month, numberOfDays);
                                EndDates.Add(lastDay);
                ...
                case ("Quarterly"):
                    {
                        Quarter objquarter = new Quarter();
                        ...
                        //#region calculating LastDayOfFirstQuarter
