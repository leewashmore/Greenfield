        ...
        public List<AttributionData> RetrieveAttributionData(PortfolioSelectionData portfolioSelectionData, DateTime effectiveDate, String nodeName)
        {
            ...
            try
            {
                for (int i = 0; i < attributionData.Count; i++)
                {
                    ...
                    entry.Bm1RcAvgWgt1w = attributionData[i].BM1_RC_TWR_1W;
                    ...
                    entry.Bm1RcAvgWgt1d = attributionData[i].BM1_RC_TWR_1D;
                    ...
                    entry.Bm1RcAvgWgtMtd = attributionData[i].BM1_RC_TWR_MTD;
                    ...
                    entry.Bm1RcAvgWgtQtd = attributionData[i].BM1_RC_TWR_QTD;
                    ...
                    entry.Bm1RcAvgWgtYtd = attributionData[i].BM1_RC_TWR_YTD;
                    ...
                    entry.Bm1RcAvgWgt1y = attributionData[i].BM1_RC_TWR_1Y;
