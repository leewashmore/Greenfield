...
namespace GreenField.Gadgets.ViewModels
{
    public class ViewModelFairValueCompositionSummary: NotificationObject
    {
        ...
        /// Stores data for fcf
        /// </summary>
        //public RangeObservableCollection<FairValueCompositionSummaryData> FairValueCompositionSummaryDataInfo
        //{
        //    get { return _FairValueCompositionSummaryDataInfo; }
        //    set
        //    {
        //        if (_FairValueCompositionSummaryDataInfo == null)
        //        {
        //            _FairValueCompositionSummaryDataInfo = new RangeObservableCollection<FairValueCompositionSummaryData>();                   
        //        }
        //       RaisePropertyChanged(() => this.FairValueCompositionSummaryDataInfo);
        //    }
        //}
        ...
        //public List<FairValueCompositionSummaryData> ReArrangingData(RangeObservableCollection<FairValueCompositionSummaryData> FairValueCompositionSummaryData)
        //{
        //    List<FairValueCompositionSummaryData> result = new List<FairValueCompositionSummaryData>();
        //    #region IF
        //    if (FairValueCompositionSummaryData != null && FairValueCompositionSummaryData.Count > 0)
        //    {
        //        List<FairValueCompositionSummaryData> data = new List<FairValueCompositionSummaryData>(FairValueCompositionSummaryData);
        //        //Revenue Growth
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "Revenue Growth").ToList();
        ...
        //        //EBITDA Margins
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "EBITDA Margins").ToList();
        //            result.Add(new FairValueCompositionSummaryData()
        //            {
        ...
        //        //EBITDA 
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "EBITDA").ToList();
        ...
        //        //(-) Taxes
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "Taxes").ToList();
        //        result.Add(new FairValueCompositionSummaryData()
        //            {
        //                FieldName = "(-) Taxes"               
        //            ,ValueY0 = data.Where(a => a.PeriodYear == System.DateTime.Now.Year).Select(a => a.Amount).FirstOrDefault().ToString()
        ...
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "Change in WC").ToList();
        //         result.Add(new FairValueCompositionSummaryData()
        //            {
        ...
        //        //(-) Capex
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "Capex").ToList();
        ...
        //        //(=) Free Cash Flow
        //        data = FairValueCompositionSummaryData.Where(a => a.FieldName == "Free Cash Flow").ToList();
        //        result.Add(new FairValueCompositionSummaryData()
        //            {
