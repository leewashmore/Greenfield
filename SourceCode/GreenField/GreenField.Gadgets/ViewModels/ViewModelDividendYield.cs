...
{
    public class ViewModelDividendYield : NotificationObject
    {
        #region Fields
        ...
        /// Stores Chart data
        /// </summary>
        private RangeObservableCollection<PRevenueData> _DividendYieldPlottedData;
        #endregion
        ...
        public ViewModelDividendYield(DashboardGadgetParam param)
        {
            ...
            {
                _dbInteractivity.RetrievePRevenueData(_securitySelectionData, RetrieveDividendYieldDataCallbackMethod);
        ...
        public RangeObservableCollection<PRevenueData> DividendYieldPlottedData
        {
            get
            {
                if (_DividendYieldPlottedData == null)
                    _DividendYieldPlottedData = new RangeObservableCollection<PRevenueData>();
                return _DividendYieldPlottedData;
            }
            set
            {
                _DividendYieldPlottedData = value;
                RaisePropertyChanged(() => this.DividendYieldPlottedData);
            }
        ...
        /// </summary>
        public event DataRetrievalProgressIndicatorEventHandler DividendYieldDataLoadEvent;
        ...
        public void HandleSecurityReferenceSet(EntitySelectionData entitySelectionData)
        {
            ...
            try
            {
                if (entitySelectionData != null && IsActive)
                {
                    ...
                    {
                        if (DividendYieldDataLoadEvent != null)
                            DividendYieldDataLoadEvent(new DataRetrievalProgressIndicatorEventArgs() { ShowBusy = true });
                        _dbInteractivity.RetrievePRevenueData(entitySelectionData, RetrieveDividendYieldDataCallbackMethod);
                    }
                }
                else
                {
        ...
        private void RetrieveDividendYieldDataCallbackMethod(List<PRevenueData> pRevenueData)
        {
            string methodNamespace = String.Format("{0}.{1}", GetType().FullName, System.Reflection.MethodInfo.GetCurrentMethod().Name);
            Logging.LogBeginMethod(_logger, methodNamespace);
            try
            {
                if (pRevenueData != null)
                {
                    ...
                    DividendYieldPlottedData.Clear();
                    DividendYieldPlottedData.AddRange(pRevenueData.ToList());
                }
                else
                {
                    Logging.LogMethodParameterNull(_logger, methodNamespace, 1);
