...
{
    /// <summary>
    /// View model for ViewTopContributor class
    /// </summary>
    public class ViewModelTopContributor : NotificationObject
    {
        #region Fields
        /// <summary>
        /// MEF Singletons
        ...
        public ViewModelTopContributor(DashboardGadgetParam param)
        {
            ...
            {
                _dbInteractivity.RetrieveRelativePerformanceSecurityData(_fundSelectionData, _benchmarkSelectionData, _effectiveDate, RetrieveRelativePerformanceSecurityDataCallBackMethod,null,null,0,5);
            }
        ...
        /// </summary>
        private ObservableCollection<RelativePerformanceSecurityData> _topContributorInfo;
        public ObservableCollection<RelativePerformanceSecurityData> TopContributorInfo
        {
            get { return _topContributorInfo; }
            set 
            {
                if (_topContributorInfo != value)
                {
                    _topContributorInfo = value;
                    RaisePropertyChanged(() => TopContributorInfo);
        ...
        public void RetrieveRelativePerformanceSecurityDataCallBackMethod(List<RelativePerformanceSecurityData> result)
        {
            ...
            try
            {
                if (result != null)
                {
                    TopContributorInfo = new ObservableCollection<RelativePerformanceSecurityData>(result);
                }
                else
                {
                    Logging.LogMethodParameterNull(_logger, methodNamespace, 1);
