...
namespace GreenField.Gadgets.ViewModels
{
    ...
    public class ViewModelICPresenterOverview : NotificationObject, INavigationAware
    {
        ...
        private ObservableCollection<StatusTypeInfo> _statusTypeInfo;
        public ObservableCollection<StatusTypeInfo> StatusTypeInfo
        {
        ...
        private StatusTypeInfo _statusTypeFilter;
        public StatusTypeInfo StatusTypeFilter
        {
        ...
        private void ICPPresentationsSearch(object param)
        {
            ...
            string Status = (StatusTypeFilter != null) ? StatusTypeFilter.StatusType : null;
        ...
        private void ICPPresentationsEditItem(object param)
        {
            ...
            _regionManager.RequestNavigate(RegionNames.MainRegion, new Uri("ViewCreateUpdatePresentations", UriKind.Relative));
        }
        ...
        private void ICPPresentationsViewItem(object param)
        {
            ...
            NavigationInfo.PresentationInfoObject = SelectedPresentation;
            _regionManager.RequestNavigate(RegionNames.MainRegion, new Uri("ViewMemberVoting", UriKind.Relative));
        }
        ...
        private void GetDistinctStatusTypesCallBackMethod(List<StatusTypeInfo> val)
        {
            StatusTypeInfo = new ObservableCollection<StatusTypeInfo>(val);
        }
