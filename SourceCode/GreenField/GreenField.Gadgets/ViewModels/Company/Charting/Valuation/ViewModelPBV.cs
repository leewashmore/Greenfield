...
namespace GreenField.Gadgets.ViewModels
{
    public class ViewModelPBV : NotificationObject
    {
        ...
        /// Stores Chart data
        /// </summary>
        private RangeObservableCollection<PRevenueData> pBVPlottedData;

        /// <summary>
        /// Stores chart title
        /// </summary>
        private string chartTitle = "P/BV";
        ...
        public RangeObservableCollection<PRevenueData> PBVPlottedData
        {
            get
            {
                if (pBVPlottedData == null)
                    pBVPlottedData = new RangeObservableCollection<PRevenueData>();
                return pBVPlottedData;
            }
            set
            {
                pBVPlottedData = value;
        ...
        private void CallingWebMethod()
        {
            ...
            {
                dbInteractivity.RetrievePRevenueData(securitySelectionData, chartTitle, RetrievePBVDataCallbackMethod);
