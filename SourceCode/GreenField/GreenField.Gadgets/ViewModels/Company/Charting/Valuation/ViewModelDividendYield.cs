...
namespace GreenField.Gadgets.ViewModels
{
    public class ViewModelDividendYield : NotificationObject
    {
        ...
        /// Stores Chart data
        /// </summary>
        private RangeObservableCollection<PRevenueData> dividendYieldPlottedData;

        /// <summary>
        /// Stores chart title
        /// </summary>
        private string chartTitle = "Dividend Yield";
        #endregion
        ...
        public RangeObservableCollection<PRevenueData> DividendYieldPlottedData
        {
            get
            {
                if (dividendYieldPlottedData == null)
                    dividendYieldPlottedData = new RangeObservableCollection<PRevenueData>();
                return dividendYieldPlottedData;
            }
            set
            {
                dividendYieldPlottedData = value;
        ...
        private void CallingWebMethod()
        {
            ...
            {
                dbInteractivity.RetrievePRevenueData(securitySelectionData, chartTitle, RetrieveDividendYieldDataCallbackMethod);
