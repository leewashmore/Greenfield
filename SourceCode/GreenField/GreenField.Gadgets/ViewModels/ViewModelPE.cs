...
namespace GreenField.Gadgets.ViewModels
{
    public class ViewModelPE : NotificationObject
    {
        ...
        /// Stores Chart data
        /// </summary>
        private RangeObservableCollection<PRevenueData> pEPlottedData;

        /// <summary>
        /// Stores chart title
        /// </summary>
        private string chartTitle = "P/E";
        #endregion
        ...
        public RangeObservableCollection<PRevenueData> PEPlottedData
        {
            get
            {
                if (pEPlottedData == null)
                    pEPlottedData = new RangeObservableCollection<PRevenueData>();
                return pEPlottedData;
            }
            set
            {
                pEPlottedData = value;
        ...
        private void CallingWebMethod()
        {
            ...
            {
                dbInteractivity.RetrievePRevenueData(securitySelectionData, chartTitle, RetrievePEDataCallbackMethod);
