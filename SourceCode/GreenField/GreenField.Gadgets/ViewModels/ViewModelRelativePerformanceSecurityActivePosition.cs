...
namespace GreenField.Gadgets.ViewModels
{
    public class ViewModelRelativePerformanceSecurityActivePosition : NotificationObject
    {
        ...
        public ViewModelRelativePerformanceSecurityActivePosition(DashboardGadgetParam param)
        {
            ...
            //}
            _dbInteractivity.RetrieveRelativePerformanceSecurityActivePositionData(_PortfolioSelectionData, _benchmarkSelectionData, _effectiveDate, RetrieveRelativePerformanceSecurityActivePositionDataCallbackMethod);
        ...
        public void HandleRelativePerformanceGridClickEvent(RelativePerformanceGridCellData filter)
        {
            ...
            try
            {
                if (filter != null)
                {
                    ...
                    //}
                    _dbInteractivity.RetrieveRelativePerformanceSecurityActivePositionData(_PortfolioSelectionData, _benchmarkSelectionData, _effectiveDate, RetrieveRelativePerformanceSecurityActivePositionDataCallbackMethod, filter.CountryID, filter.SectorID);
                }
                else
                {
                    Logging.LogMethodParameterNull(_logger, methodNamespace, 1);
