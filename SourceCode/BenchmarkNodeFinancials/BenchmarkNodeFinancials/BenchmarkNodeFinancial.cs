...
namespace BenchmarkNodeFinancials
{
    class BenchmarkNodeFinancial
    {
        ...
        public void RetrieveData()
        {
            ...
            var doc = XDocument.Load(@"C:\Users\spuniyani\Documents\Visual Studio 2010\Projects\BenchmarkNodeFinancials\BenchmarkNodeFinancials\HelperFiles\BenchmarkIDs.xml");

            List<String> benchmarkIds = doc.Descendants("BenchmarkId")
                .Select(a => a.Value)
                .ToList();
            ...
            foreach (String benId in benchmarkIds)
            {
                ...
                //Grouping the data and calculating the Harmonic mean

                GroupBenchmarkData(bothRatiosData);
            }

        }

        public List<SecurityData> RetrieveSecurityIds(List<String> asecShortNames)
        {
        ...
        public List<BenchmarkNodeFinancialsData> FillBenchmarkNodeFinancials(List<PeriodFinancialForwardRatios> periodFinancialData, List<SecurityData> securityData, List<GF_BENCHMARK_HOLDINGS> dataBenchmarkHoldings, String benId)
        {
            List<BenchmarkNodeFinancialsData> forwardRatioData = new List<BenchmarkNodeFinancialsData>();
        ...
        public List<BenchmarkNodeFinancialsData> FillBenchmarkNodeFinancialsPeriodData(List<PeriodFinancialPeriodRatios> periodFinancialRatioData, List<SecurityData> securityData, List<GF_BENCHMARK_HOLDINGS> dataBenchmarkHoldings, String benId, List<BenchmarkNodeFinancialsData> periodRatiosData)
        {
        ...
        public List<GroupedBenchmarkNodeData> GroupBenchmarkData(List<BenchmarkNodeFinancialsData> bothRatiosData)
        {
